...
class MyApp(QWidget):
   ...
   # setting font style
    ...
    def init_ui(self):
        ...
        self.proc_table.setHorizontalHeaderLabels(["Process Name", "Arrival Time", "Burst Time","Priority"])
    ...
    def add(self):
        ...
        if self.cur_algo=="PB":
            ...
            self.proc_list.append(Process(proc_name, self.at.value(), self.bt.value(), self.process_count,self.priority_list.value()))
